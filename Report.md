...
### Διευκρινίσεις
Σχετικά με την επιλογή χρήστη όπου αυτό απαιτείται, ο χρήστης της επιλογής μας είναι ο 90.
...
Η μετρική Pearson χρησιμοποιείται συνήθως όταν οι τυχαίες μεταβλητες (στη περίπτωση μας τα διανύσματα των χρηστών) είναι σε διαφορετικές μονάδες μέτρησης ή κλίμακες και προσπαθούμε να βρούμε το συσχετισμό τους.
